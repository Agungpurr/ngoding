        ...
        <div className="hero grid md:grid-cols-2 grid-cols-1 items-center gap-20 pt-32">
          <div className="box">
            ...
            <p className="text-base/8 mb-7">
              ...
              vel aliquid nobis! Minima ipsam porro tenetur at excepturi ratione
              aliquam veniam, illum laborum doloribus, quisquam accusamus eos
              soluta necessitatibus?
            </p>
            <a
              href="#"
              className="inline-flex items-center gap-2 bg-sky-400 hover:bg-sky-500 transition-all py-2 px-4 text-white shadow rounded-full"
            >
              Tentang Kami <RiEyeLine className="text-lg" />
            </a>
          </div>
          <div className="box">
            <img
        ...
        >
          <div className="box md:order-1 order-2">
            <img
              src={AboutImage}
              alt="About Image"
              className="lg:w-[500px] w-[400px] md:0 mx-auto"
            ></img>
          </div>
          ...
          <div className="services-box pt-12 grid md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-6">
            <div className="box bg-sky-400 rounded-lg shadow p-4">
              ...
              <p className="text-white text-base/loose">
                ...
                Corrupti ab distinctio a sunt cupiditate dolore debitis
                voluptatum ex.
              </p>
            </div>
            <div className="box bg-sky-400 rounded-lg shadow p-4">
        ...
        <div className="proyek pt-32" id="proyek">
          ...
          <div className="proyek-box pt-12 grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-6">
            <div className="box p-2 bg-white shadow">
              ...
              <p className=" text-base/loose">
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Dignissimos, recusandae excepturi. Debitis dolorem molestias
                perspiciatis.
              </p>
            </div>
            <div className="box p-2 bg-white shadow">
